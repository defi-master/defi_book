...
ساختار کلی کتاب مشابه کتاب how to defi هستش ( این کتاب اولین کتابی بود که درباره دی‌فای نوشته شده) اما با توجه به این که دی‌فای سرعت رشد سریعی داره مطالب این کتاب پیشرفت های مهم بعدی رو پوشش نداده اما ما در این کتاب سعی میکنیم تا جایی که در توان داریم این پیشرفت ها رو هم در کتاب لحاظ کنیم
